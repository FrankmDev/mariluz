export const siteConfig = {
  ...
  meta: {
    title: 'luzaria | Revisión gratuita de factura de luz',
    description: 'Asesoría energética en España: Mariluz Marín revisa gratis tu factura de luz, compara tarifa, potencia y condiciones, y te explica si puedes mejorar.',
    ogImage: '/og-image.svg',
    ogImageAlt: 'luzaria - Revisión gratuita de factura de luz',
    canonical: 'https://luzaria.es/',
    keywords: 'revisión factura luz, asesoría energética España, asesor energético luz, ahorrar factura luz, tarifa luz, potencia contratada, cambiar comercializadora luz, factura eléctrica',
